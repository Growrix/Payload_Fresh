    ...
    <footer ref={ref} className="bg-[#0B0B0B] py-20 px-6 border-t border-[#9C6BFF]/10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 font-['Space_Grotesk']">GrowRix</h3>
            <p className="text-[#B0B0B0] mb-6 font-['Inter'] leading-relaxed">
              We engineer digital experiences that transform businesses and delight users. Let's
          ...
          >
            <h4 className="text-xl font-bold mb-6 font-['Space_Grotesk'] text-white">Company</h4>
          ...
          >
            <h4 className="text-xl font-bold mb-6 font-['Space_Grotesk'] text-white">Services</h4>
            <ul className="space-y-3">
          ...
          >
            <h4 className="text-xl font-bold mb-6 font-['Space_Grotesk'] text-white">Resources</h4>
            <ul className="space-y-3">
        ...
        >
          <div className="flex items-center space-x-4 mb-4 md:mb-0">
            <div className="text-2xl font-bold font-['Space_Grotesk'] text-[#9C6BFF]">GR</div>
            <p className="text-[#B0B0B0] font-['Inter']">© 2024 GrowRix. All rights reserved.</p>
          </div>
