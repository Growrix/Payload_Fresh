...
export const mockCategories: MockCategory[] = [
  { id: '1', name: 'Development', slug: 'development', description: 'Programming and development tutorials', postCount: 15 },
  { id: '2', name: 'Design', slug: 'design', description: 'UI/UX design insights and tips', postCount: 8 },
  { id: '3', name: 'JavaScript', slug: 'javascript', description: 'JavaScript and related frameworks', postCount: 12 }
];
...
export const mockBlogService = {
  getPosts: ({ limit = 10, category, tag }: { limit?: number; category?: string; tag?: string } = {}) => {
