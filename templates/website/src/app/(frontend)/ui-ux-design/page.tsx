...
export default function UIUXDesignPage() {
  ...
  const services = [
    {
      ...
      title: 'UI Design',
      description:
        'Beautiful, intuitive interfaces that engage users and reflect your brand identity.',
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'Creating wireframes, mockups, and design concepts',
      icon: PenTool,
    },
    {
      step: '03',
      title: 'Prototype & Test',
      description: 'Building interactive prototypes and user testing',
      icon: MousePointer,
    },
    {
      step: '04',
      title: 'Deliver & Support',
      description: 'Final designs with ongoing support and iterations',
      icon: CheckCircle,
    },
  ]

  const stats = [
    { number: '150+', label: 'Designs Created', icon: Palette },
    { number: '98%', label: 'Client Satisfaction', icon: Heart },
    { number: '45%', label: 'Avg. Conversion Boost', icon: TrendingUp },
    { number: '4.9★', label: 'Design Rating', icon: Star },
  ]
        ...
        <section className="py-20 px-6 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
              ...
              >
                We create user-centered designs that not only look beautiful but drive results. From
                research to final product, we craft experiences that users love.
              </motion.p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 font-['Inter'] max-w-3xl mx-auto">
                Comprehensive design solutions from concept to conversion
              </p>
            </motion.div>
