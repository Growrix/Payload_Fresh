...
export default function PostsTable() {
  ...
  const handleSaveQuickEdit = async () => {
    ...
    try {
      ...
      // await saveDraft(editingPost.id, { 
  ...
  if (posts === null) {
    return (
      <div className="flex items-center justify-center py-12" style={{ backgroundColor: '#0b0b0b' }}>
        <div className="animate-spin rounded-full h-8 w-8 border-b-2" style={{ borderBottomColor: '#9333ea' }}></div>
  ...
  return (
    <div style={{ backgroundColor: '#0b0b0b' }}>
      {/* Header */}
      <div className="flex items-center justify-between p-6 border-b border-gray-800" style={{ backgroundColor: '#181818' }}>
        <div>
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-md hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#9333ea] transition-all"
        >
          <PlusIcon />
          Add New Post
        </Link>
      ...
      {/* Filters */}
      <div className="p-6 border-b border-gray-800" style={{ backgroundColor: '#181818' }}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
          <div className="relative">
            <input
              ...
              className="w-full pl-8 pr-3 py-2 border border-gray-800 text-white placeholder-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-[#9333ea]"
            />
          ...
          <select
            ...
            style={{ backgroundColor: '#0b0b0b' }}
            className="px-3 py-2 border border-gray-800 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-[#9333ea]"
          >
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead style={{ backgroundColor: '#181818' }} className="border-b border-gray-800">
            <tr>
              <th className="w-12 px-6 py-3 text-left">
                <input
                  ...
                  style={{ backgroundColor: '#0b0b0b', accentColor: '#9333ea' }}
                  className="rounded border-gray-800 focus:ring-[#9333ea]"
                />
              </th>
          ...
          <tbody style={{ backgroundColor: '#0b0b0b' }} className="divide-y divide-gray-800">
            {paginatedPosts.map((post) => (
              <tr key={post.id} className="group hover:bg-gray-900 transition-colors">
                <td className="px-6 py-4">
                  <input
                    type="checkbox"
                    checked={selectedPosts.has(post.id)}
                    onChange={(e) => handleSelectPost(post.id, e.target.checked)}
                    style={{ backgroundColor: '#181818', accentColor: '#9333ea' }}
                    className="rounded border-gray-800 focus:ring-[#9333ea]"
                  />
                </td>
                <td className="px-6 py-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {post.tags.slice(0, 2).map((tag) => (
                      <span
                        ...
                        className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium border border-gray-800 text-gray-300"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      {paginatedPosts.length === 0 && (
        <div className="text-center py-12" style={{ backgroundColor: '#0b0b0b' }}>
          ...
          <Link
            href="/growrix-admin/blog/posts/new"
            style={{ backgroundColor: '#9333ea' }}
            className="inline-flex items-center gap-2 px-4 py-2 text-white rounded-md hover:opacity-90"
          >
            <PlusIcon />
