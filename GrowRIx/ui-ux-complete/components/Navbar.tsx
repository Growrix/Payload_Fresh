    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <Link href="/" className="text-[#B0B0B0] hover:text-white transition-colors font-['Inter']">
            Home
          </Link>
          <Link href="/demo-wall" className="text-[#B0B0B0] hover:text-white transition-colors font-['Inter']">
            Demo Wall
          </Link>
          <Link href="/blog" className="text-[#B0B0B0] hover:text-white transition-colors font-['Inter']">
            Blog
          </Link>
          <a href="#shop" className="text-[#B0B0B0] hover:text-white transition-colors font-['Inter']">
            Shop
          </a>
          <Link href="/contact" className="text-[#B0B0B0] hover:text-white transition-colors font-['Inter']">
            Contact
          </Link>
